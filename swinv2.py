...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.attn = WindowAttention(
            dim,
            window_size=utils.to_2tuple(self.window_size),
            num_heads=num_heads,
            qkv_bias=qkv_bias,
            attn_drop=attn_drop,
            proj_drop=drop,
            pretrained_window_size=utils.to_2tuple(pretrained_window_size),
        )
...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        img_size = utils.to_2tuple(img_size)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.ape:
            ...
            torch.nn.init.trunc_normal_(self.absolute_pos_embed, std=0.02)
